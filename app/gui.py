...
class DashboardPage(QWidget):
    ...
    def __init__(self) -> None:
        ...
        if show_cleanup_button:
            self.cleanup_testdata_btn = QPushButton("Cleanup")
        ...
        if self.cleanup_testdata_btn is not None:
            batch_grid.addWidget(self.cleanup_testdata_btn, 2, 0, 1, 2)
...
class AnalysePage(QWidget):
    ...
    def __init__(self, *, service: OrchestratorService) -> None:
        ...
        self.flags_help_btn.setIcon(QIcon(":/icons/info.svg"))
        ...
        self.auto_scale_btn = QToolButton()
        self.auto_scale_btn.setObjectName("AnalyzerAutoScaleButton")
        self.auto_scale_btn.setText("Auto Scale")
        self.auto_scale_btn.setCheckable(True)
        self.auto_scale_btn.setToolButtonStyle(Qt.ToolButtonTextOnly)
        self.auto_scale_btn.setProperty("analyzerToggle", True)
    ...
    def _create_stage_plot_panel(
        ...
        *,
        ...
        help_btn.setText("")
        help_btn.setIcon(QIcon(":/icons/info.svg"))
