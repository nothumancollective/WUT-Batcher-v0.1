...
## Tables and Columns
- `experiment_compare`: rows=15640, columns=run_id, config_ok, no_ghosts, missing_keys_required_json, missing_keys_optional_json, extra_keys_defaulted_json, extra_keys_ghost_json, mismatch_json
- `experiment_metrics`: rows=15640, columns=run_id, final_width_mm, final_height_mm, final_length_mm, avg_throat_angle_deg, derived_volume_m3, flags_json
- `experiment_params`: rows=828920, columns=run_id, key, value_text, value_num, is_set
- `experiment_runs`: rows=15640, columns=run_id, created_at, seed, case_index, status, ath_exit_code, ath_error_kind, ath_error_message, ath_warning_count, cfg_path, horns_export_dir, stdout_path, stderr_path, notes, run_group_id
